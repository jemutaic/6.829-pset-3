...
python sim/run_exp.py -- --mm-trace=/tmp/scaled1/verizon1.txt --results-dir=results/scaled1/verizon1Results

python sim/run_exp.py -- --mm-trace=/tmp/scaled1/verizon2.txt --results-dir=results/scaled1/verizon2Results

python sim/run_exp.py -- --mm-trace=/tmp/scaled1/Att1.txt --results-dir=results/scaled1/Att1Results 

python sim/run_exp.py -- --mm-trace=/tmp/scaled1/Att2.txt --results-dir=results/scaled1/Att2Results

python sim/run_exp.py -- --mm-trace=/tmp/scaled1/TMobile1.txt --results-dir=results/scaled1/TMobile1Results

python sim/run_exp.py -- --mm-trace=/tmp/scaled1/TMobile2.txt --results-dir=results/scaled1/TMobile2Results
